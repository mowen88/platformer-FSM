...
class Game:
    def __init__(self):
        ...
        #font
        self.big_font = pygame.font.Font(FONT, TILESIZE)#round(HEIGHT * 0.1))
        self.medium_font = pygame.font.Font(FONT, int(TILESIZE*0.5)) #round(HEIGHT * 0.05))
        self.small_font = pygame.font.Font(FONT, int(TILESIZE*0.4))#round(HEIGHT * 0.03))
